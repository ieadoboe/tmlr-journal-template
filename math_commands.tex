...
\renewcommand{\train}{\mathcal{D}_{\text{train}}}
\newcommand{\val}{\mathcal{D}_{\text{val}}}
\renewcommand{\test}{\mathcal{D}_{\text{test}}}

% Big-O notation
\newcommand{\bigo}[1]{\mathcal{O}\!\left( #1 \right)}

% Floor and ceiling (auto-sizing, overrides the basic versions above)
...
\newcommand{\Pclass}{\textsf{P}\xspace}
